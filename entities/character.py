class Character:
    def __init__(self, name: str, surname: str, title: str, race: str, sex: str, birthday: str, height: str,
                 functions: list[str], character_class: str, subclasses: list[str], masterclass: str, homes: list[str],
